...
export const CharacterPage = () => {
    ...
    return (
        <Container fluid className="p-2 bg-dark vh-100 text-warning border border-warning">
            <Row className="px-3 fixed-top">
                ...
                <Col sm={{span: 9, offset: 3}} className="bg-dark border border-warning p-2">
            ...
            <Col sm={{span: 3, offset: 0}} className="flex-column border border-warning vh-100 fixed-top mt-5 pt-1 overflow-auto">
                <p>Acrobaties</p>
